<template>
    <div :class="classes">
        <button type="button" :class="arrowClasses" class="left" @click="arrowEvent(-1)" style="margin-top:-35px">
        ...
        <button type="button" :class="arrowClasses" class="right" @click="arrowEvent(1)" style="margin-top:-35px">
            <Icon type="ios-arrow-forward"></Icon>
        </button>
        <ul :class="dotsClasses" style="padding-left:320px">
            <template v-for="n in slides.length">
                <li :class="[n - 1 === currentIndex ? prefixCls + '-active' : '']" @click="dotsEvent('click', n - 1)" @mouseover="dotsEvent('hover', n - 1)">
                    <button type="button" :class="[radiusDot ? 'radius' : '']" style="width:22px;height:22px;margin-top:-38px;"></button>
                </li>
            </template>
        </ul>
    </div>
